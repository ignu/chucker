...
class CreaturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create creature" do
    assert_difference("Creature.count") do
      post creatures_url, params: { creature: { ac: @creature.ac, hp: @creature.hp, name: @creature.name } }
    end
  ...
  test "should update creature" do
    patch creature_url(@creature), params: { creature: { ac: @creature.ac, hp: @creature.hp, name: @creature.name } }
